<!-- Page section -->
<section class="page-section review-page spad set-bg" data-setbg="">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="review-item border rounded">
                    ...
                    <div class="review-text">
                        ...
                        <p><a href="#contact-form" class="site-btn btn-sm mb-1" target="_blank" type="button">Contacto</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="review-item border rounded">
                    <div class="review-cover set-bg" data-setbg="img/courses/web-dev.jpg">
                        <div class="score purple">9.6</div>
                    </div>
                    <div class="review-text">
                        <h4>Desarrollo Web 1</h4>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-md-6">
                <div class="review-item border rounded">
                    <div class="review-cover set-bg" data-setbg="img/courses/react.jpg">
