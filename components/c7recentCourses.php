        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="recent-course-item">
                    <div class="rgi-thumb set-bg" data-setbg="img/courses/lang_english.jpg">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="recent-course-item">
                    <div class="rgi-thumb set-bg" data-setbg="img/courses/lang_chinese.jpg">
                        <div class="cata adventure">Inicial</div>
                    </div>
                    <div class="rgi-content">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="recent-course-item">
                    <div class="rgi-thumb set-bg" data-setbg="img/courses/lang_russian.jpg">
                        <div class="cata adventure">Inicial</div>
                    </div>
                    <div class="rgi-content">
